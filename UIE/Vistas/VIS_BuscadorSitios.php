            ...
            <div class="row mt-4">
                ...
                <div class="col-md-8">
                    <form class="d-flex ms-3 search-form justify-content-center" id="form-busqueda">
                        ...
                        <button class="btn custom-search-btn" type="submit"><i class="fas fa-search"></i></button>
                    </form>
                </div>
            </div>
                ...
                <div class="col-md-6 offset-md-2 ">
                    <div class="d-flex justify-content-between">
                        <div class="dropdown me-2"> 
                            <button class="btn custom-filter-btn dropdown-toggle w-100" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown">
                                Categorías
                            </button>
                        ...
                        <div class="dropdown me-2"> 
                            <button class="btn custom-filter-btn dropdown-toggle w-100" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown">
                                Etiquetas
                            </button>
                            <ul class="dropdown-menu">
                                <li>AAA</li>
                        ...
                        <div class="dropdown">
                            <button class="btn custom-filter-btn dropdown-toggle w-100" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown">
                                Localidad
                            </button>
                            <ul class="dropdown-menu">
                            <?php foreach ($localidades as $localidad):?>
                                <li><a class="dropdown-item filtro" data-filtro="<?= $localidad['nombre'] ?>" href="#"><?= $localidad['nombre'] ?></a></li>
                            <?php endforeach; ?>
                            </ul>
                        </div>
                    </div>
