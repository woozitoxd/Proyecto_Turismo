...
<form class="needs-validation" action="" method="get" id="form-">
    <div class="container-fluid mt-3 row ">
      ...
      <div class="mb-2 col-lg-6">
        ...
        <div class="d-inline">
          <p class="d-inline EstilosCategorias" id="CategoriaSeleccionada"> CategoriaSeleccionada</p><!---aca deberia traerlo del select -->
        </div>
        ...
        <button type="button " onclick="EliminarSelect()" class="btn btn-outline-danger d-inline">-</button>
          <div class="row">
            <div class="col-12" id="IDContenedorSelectEtiquetas">
